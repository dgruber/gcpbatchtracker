module github.com/dgruber/gcpbatchtracker/examples/drmaa2job

go 1.18

replace github.com/dgruber/gcpbatchtracker => ../../

require (
	github.com/dgruber/drmaa2interface v1.1.0
	github.com/dgruber/drmaa2os v0.3.24
	github.com/dgruber/gcpbatchtracker v0.0.0-00010101000000-000000000000
)
